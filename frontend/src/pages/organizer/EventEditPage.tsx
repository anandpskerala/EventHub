...
import z from 'zod';
import { updateEventService, getEventById } from '@/services/eventService';
...
const EventEditPage = () => {
        ...
        const fetchEvent = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    image: event.image,
                    ticketTiers: event.ticketTiers.map((tier: TicketTier) => ({
                        id: tier.id,
                        name: tier.name,
                        price: tier.price,
    ...
    const handleUpdateEvent = async () => {
        if (validate()) {
            ...
            try {
                await updateEventService(id as string, formDataToSend);
                        ...
                        <Card className="border-0 shadow-xl shadow-gray-200/50 backdrop-blur-sm bg-white/80">
                            <CardHeader className="border-b border-gray-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl">Edit Event Details</CardTitle>
                            ...
                            <CardHeader className="border-b border-gray-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription>Update pricing options for attendees</CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            <CardContent className="space-y-6 pt-6">
